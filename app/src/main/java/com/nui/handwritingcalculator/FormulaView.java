...
public class FormulaView extends View {
    ...
    public FormulaView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mExampleColor = a.getColor(
                R.styleable.FormulaView_exampleColor,
                mExampleColor);
        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        mExampleDimension = a.getDimension(
                R.styleable.FormulaView_exampleDimension,
                mExampleDimension);

        if (a.hasValue(R.styleable.FormulaView_exampleDrawable)) {
            mExampleDrawable = a.getDrawable(
                    R.styleable.FormulaView_exampleDrawable);
